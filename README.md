...
- [Abstract](#abstrackt)
- [Top Models by PSNR and SSIM Performance](#Top-Models-by-PSNR-and-SSIM-Performance)
- [Key Observations](#key-observations)
- [Visual Results](#visual-results)
- [Dataset](#dataset)
- [Hardware and Training Configuration](#hardware-and-training-configuration)
...
This document presents our main experimental setup and results; for baseline comparisons and additional methodology details, see [METHODOLOGY_BASELINES.md](METHODOLOGY_AND_EXPERIMENTS.md).
